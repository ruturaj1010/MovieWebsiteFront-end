...
const Header = ( { data } ) => {
    ...
    return (
        <div style={ {
            ...
            className='w-full h-[55vh] flex flex-col justify-end items-start px-[7%] pb-6
        '>
            ...
            <p ><i className="ri-megaphone-fill my-1 mr-1 capitalize "></i> Release Date : <span className='text-rose-500 uppercase text-base'>{ data.first_air_date }</span> on <span className='text-rose-500 uppercase text-base'>{ data.media_type }</span></p>
            <p ><i className="ri-film-line mr-1"></i> Rating : <span className='text-rose-500 uppercase text-base'>{ data.vote_average }</span> out of 10 </p>
