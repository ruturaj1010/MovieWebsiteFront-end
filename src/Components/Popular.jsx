...
const Popular = () => {
    ...
    document.title = `Movies+More | Popular ${category.toUpperCase()}`;
    ...
    return (
        <div className="w-full h-full relative">
            ...
            <div className="w-full md:px-10 px-2 py-5 md:py-0 z-10 sticky top-0 left-0 flex justify-between items-center bg-purple-500">
                <h1 className="md:w-1/6 w-4/6 text-2xl font-semibold tracking-wide select-none">
                    <i onClick={ () => navigate( -1 ) } className="text-purple-300 mr-2 cursor-pointer ri-arrow-left-line"></i>
                    Popular  <small className="text-sm text-zinc-300">({ category.toUpperCase() })</small>
                </h1>
